...
export const SiteWaitingYouEmailTemplate: EmailTemplate = {
                  ...
                  >
                    ...
                    <tr>
                      <td align="center" style="padding: 32px 24px 10px 24px">
                        ...
                        >
                          You Started Something Great. Don’t leave It Unfinished.
                        </p>
                        <p
                          class="muted"
                          style="margin: 0; font-size: 17px; line-height: 28px; color: #747988"
                        >
                          Just One Click And Your Website Is Live.
                        </p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td align="center" style="padding: 25px 0 65px 0">
                        <img
                          src="https://i.ibb.co/nqgXCQ8X/Macbook-Air-2022-Space-Gray-Front-View.png"
                          width="520"
