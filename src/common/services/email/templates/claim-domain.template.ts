...
export const ClaimDomainEmailTemplate: EmailTemplate = {
                  ...
                  >
                    ...
                    <tr>
                      <td align="center" style="padding: 32px 24px 10px 24px">
                        ...
                        >
                          Your Stunning Site Needs A Domain!
                        </p>
                        <p
                          class="muted"
                          style="margin: 0; font-size: 17px; line-height: 28px; color: #747988"
                        >
                          Claim One Now Before Anybody Else Can.
                        </p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td align="center" style="padding: 0">
                        <img
                          src="https://i.ibb.co/v7QsbsW/Frame-222.png"
                          width="520"
